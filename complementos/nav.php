...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Courgette&family=EB+Garamond&family=Ysabeau+Infant:wght@500&display=swap" rel="stylesheet">
...
<header>
        ...
        <img src="imgs/logo.png" alt="foto 1" width="200" height="50" class="rounded img-fluid d-md-block" id="logo"> 
            ...
            <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link color" id="principal" href="index.php">Inicio</a>
                    </li>
                    <li class="nav-item">
